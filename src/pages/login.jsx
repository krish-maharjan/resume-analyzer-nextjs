        ...
        <section className="flex flex-col justify-center items-center my-16 mt-32 xl:px-52 lg:px-32 md:px-16 sm:px-10 gap-5">
            <div className="card w-full bg-slate-50 shadow-2xl backdrop-filter backdrop-blur-lg bg-opacity-30 firefox:bg-opacity-90 max-w-fit">
                <form onSubmit='' className="card-body max-w-fit flex justify-center items-center p-9">
                    ...
                    <div className="">
                        <label className="text-sm input-group input-group-vertical text-black">Your email</label>
                        <input type="email" className="input input-bordered w-full max-w-xs text-black"/>
                    </div>

                    <div>
                        <label className="text-sm input-group input-group-vertical text-black">Your password</label>
                    ...
                    <div>
                        <button className="btn btn-primary w-full">Login to your account</button>
                    </div>
