            ...
            <div className="flex flex-row flex-wrap justify-center items-center gap-6">
                ...
                {Object.entries(plans).map(([plan, details]) => (
                    <div class="card bg-base-100 shadow-xl p-7">
                        <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">{plan}</h5>

                        <div class="flex items-baseline text-gray-900 dark:text-white">
                            <span class="text-3xl font-semibold">$</span>
                            <span class="text-5xl font-extrabold tracking-tight">{details[0].price}</span>
                        ...
                        <ul role="list" class="space-y-5 my-7">
                            {details[1].provided.map((item) => (
                                <li class="flex space-x-3">
                                    <svg aria-hidden="true" class="flex-shrink-0 w-5 h-5 text-blue-600 dark:text-blue-500" fill="currentColor" viewBox="0 0 20 20"><title>Check icon</title><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                            ...
                            {details[2].notprovided.map((item) => (
                                <li class="flex space-x-3 line-through decoration-gray-500">
                                    ...
                                    <span class="text-base font-normal leading-tight text-gray-500">{item}</span>
                                </li>
                            ))}
                        </ul>
